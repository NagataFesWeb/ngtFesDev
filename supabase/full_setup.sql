...
--   20260407000000_add_cancel_ticket.sql
--   20260411195928_update_operator_project_rpc.sql
--   20260411444444_add_projects.sql
--   20260416110000_add_quiz_explanation_column.sql
--
...
('buturi', 'exhibition', '物理部', 'クイズしようぜ！', false, '203教室', NULL, 305),
('syasin', 'exhibition', '写真部', '心動く瞬間を、切り取れ。', false, '205教室', NULL, 306),
...
('長田高校の創立年はいつでしょうか？', '["1918年", "1920年", "1921年", "1945年"]'::jsonb, 2, '長田高校は1921年に創立されました。'),
('長田高校の校訓として正しいものはどれ？', '["自主・自律", "質実剛健", "文武両道", "神武不殺"]'::jsonb, 0, '長田高校の校訓は「自主・自律」です。'),
('長田高校の象徴的な建物である「神撫台（しんぶだい）」の由来は？', '["近くの山の名前", "創立者の名前", "地元の神社の名前", "神戸の古い地名"]'::jsonb, 0, '神撫台は近くの山の名前です。'),
('長田高校の制服（冬服）の特徴的な色は？', '["ネイビーブルー", "チャコールグレー", "ブラック", "ダークグリーン"]'::jsonb, 0, '長田高校の制服（冬服）はネイビーブルーです。'),
('長田祭（文化祭）の通例の開催時期は？', '["4月上旬", "5月上旬", "9月上旬", "11月下旬"]'::jsonb, 1, '長田祭（文化祭）は例年5月上旬に開催されます。'),
('長田高校の生徒会にあたる組織の名称は？', '["自治会", "生徒協議会", "学友会", "中央委員会"]'::jsonb, 0, '長田高校の生徒会にあたる組織の名称は「自治会」です。'),
('長田高校の校章にデザインされている植物は？', '["桜", "梅", "松", "菊"]'::jsonb, 2, '長田高校の校章にデザインされている植物は「松」です。'),
('長田高校のグラウンドの特徴は？', '["全面人工芝", "非常に広い土のグラウンド", "地下にある", "陸上トラックが青色"]'::jsonb, 1, '長田高校のグラウンドは非常に広い土のグラウンドです。'),
('長田高校の最寄りの鉄道駅はどれ？', '["長田駅", "高速長田駅", "板宿駅", "新長田駅"]'::jsonb, 1, '長田高校の最寄りの鉄道駅は「高速長田駅」です。'),
('長田高校の部活動で、全国大会の常連として有名な文化部は？', '["吹奏楽部", "音楽部(合唱)", "演劇部", "書道部"]'::jsonb, 1, '長田高校の部活動で、全国大会の常連として有名な文化部は「音楽部(合唱)」です。'),
('長田高校周辺で人気のご当地グルメはどれ？', '["そばめし", "明石焼き", "神戸牛バーガー", "豚まん"]'::jsonb, 0, '長田高校周辺で人気のご当地グルメは「そばめし」です。'),
('長田高校の生徒手帳の表紙の色は？', '["えんじ色", "紺色", "黒色", "深緑色"]'::jsonb, 0, '長田高校の生徒手帳の表紙の色は「えんじ色」です。');
