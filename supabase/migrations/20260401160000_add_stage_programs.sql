...
-- Remove existing stage programs for these classes to avoid duplicates (projects table doesn't have a unique constraint on class_id)
DELETE FROM public.projects WHERE class_id IN ('brass-band', 'dance');
